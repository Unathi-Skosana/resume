...
\begin{minipage}[t]{0.45\linewidth}
   ...
   Merriman Ave, Stellenbosch, \vspace*{0.2cm} \\
   7600
\end{minipage}
\hfill
\begin{minipage}[t]{0.5\linewidth}
	\textbf{google scholar} \href{https://scholar.google.com/citations?user=SR58SqgAAAAJ}{scholar.google.com} \vspace*{0.2cm} \\
...
\textit{Expected completion}: First half of 2026 \\
\textit{Focus}: Variational quantum algorithms, quantum chemistry and experimental quantum photonics}

\entry{2020 -- 2022}{\textbf{MSc} in Quantum applications and photonics (\textit{cum laude}), Stellenbosch University (SU) \\
  \textit{Thesis}: \href{https://github.com/Unathi-Skosana/mastersthesis}{Quantum computing on cloud-based processors}}
...
\entry{2026}{\textbf{Unathi Skosana}, Byron Alexander and Mark Tame \href{https://arxiv.org/abs/2602.18177}{Experimental realization of a photonic weighted graph state for quantum metrology}. ArXiv preprint (Feb 2026)}
